        ...
        <body>
            <header
                ...
                <div class="flex flex-col justify-center items-center">
                    ...
                    <p class="mt-5 text-center text-lg text-dark  dmsans pt-4 pb-8">Use our survey maker to collect information from your students, upload to gruepr, and our algorithm will find you the best set of teams.</p>
